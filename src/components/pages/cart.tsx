...
function Cart() {
    ...
    const { totalPrice, totalCount, pizzas} = UseTypedSelector(({ cartState }) => cartState);

    return (
        <div className="content">
            {visibleWindow && <ModalWindow setVisibleWindow={setVisibleWindow}/>}
                 ...
                 <div className="cart">
                    <div className="cart__top">
                        ...
                        <div className="cart__clear">
                            ...
                            <span onClick={() => setVisibleWindow(true)}>Очистить корзину</span>
                        </div>
                    </div>
                    <div className="content__items">
                        {pizzas.map((pizza: any) => <CardItem key={pizza.id + pizza.type + pizza.size} {...pizza} />)}
                    </div>
